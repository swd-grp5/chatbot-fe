...
import { switchDemoAccount } from "@/lib/mock-auth";
import {
...
const DEMO_EMAILS = new Set(["admin@demo.edu", "lecturer@demo.edu", "student@demo.edu"]);
...
export function AppShell({ children, fullBleed = false }: { children: React.ReactNode; fullBleed?: boolean }) {
  ...
  const isDemo = !!account && DEMO_EMAILS.has(account.email);
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                {isDemo &&
                  otherDemoRoles.map((r) => {
                    ...
                    return (
                      <DropdownMenuItem key={r} onClick={() => switchDemoAccount(r)}>
